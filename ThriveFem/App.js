          ...
          >
            <View style={styles.headerContainer}>
              ...
              <View style={styles.nodeBadge}>
                <Text style={styles.nodeText}>
                  SYSTEM NODE: {activeData?.timestamp_node?.toUpperCase()}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.matrixGrid}>
              <TelemetryCard 
                ...
                subtext={activeData?.heart_rate_variability_rmssd < 40 ? "— Sympathetic Tension" : "— Balanced"}
                icon={Zap}
              />
              <TelemetryCard 
                label={T.sleep}
...
const styles = StyleSheet.create({
  ...
  brandText: { color: COLORS.primary, fontSize: 11, fontWeight: '900', letterSpacing: 2.5, textTransform: 'uppercase' },
  viewTitle: { color: COLORS.text, fontSize: 34, fontWeight: 'bold', letterSpacing: -0.5, marginTop: 4 },
  ...
  matrixGrid: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 },
